  ...
  async crear(input: CrearUnidadInput): Promise<UnidadVista> {
    ...
    const unidad = await this.prisma.unidad.create({
      data: {
        ...
        rendimientoKmL: input.rendimientoKmL,
        capacidadTanqueL: input.capacidadTanqueL,
        capacidadPasajeros: input.capacidadPasajeros,
        costoMantenimientoPorKm: input.costoMantenimientoPorKm,
        costoFijoMensual: input.costoFijoMensual,
